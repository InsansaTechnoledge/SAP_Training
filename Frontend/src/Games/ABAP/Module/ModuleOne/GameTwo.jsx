    ...
    const handleChallengeAttempt = () => {
        ...
        setTimeout(() => {
            ...
            if (currentLevel === 1) {
                ...
                // Level 3: Write code
                isCorrect = userInput.trim().split('\n').every(
                    line => challenge.solution.includes(line.trim())
                );
            }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="bg-gray-900/80 p-6 rounded-2xl border border-purple-500/30">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                >
                                    {isMapExpanded ? <ChevronUp className="w-6 h-6" /> : <ChevronDown className="w-6 h-6" />}
                                </button>
                            </div>
                            ...
                            <AnimatePresence>
                                {isMapExpanded && (
                                    ...
                                    >
                                        <div className="space-y-4">
                                            {currentLevelPath.map((node, index) => (
                                                <div
                                                    key={node.id}
                                ...
                                >
                                    ...
                                    {codeSuccess && (
                                        <motion.button
                                            ...
                                            disabled={currentNodeIndex >= currentLevelPath.length - 1}
                                        >
